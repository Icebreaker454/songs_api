...
## Development environment and release process
 ...
 - create virtualenv with Flask and SongsAPI installed into it (latter is installed in
...
install it (`pip install songsapi.tar.gz`), ensure that configuration file exists and
`SONGSAPI_SETTINGS` environment variable points to it, ensure that user has access to the
